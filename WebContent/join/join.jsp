...
<link rel="stylesheet" type="text/css" href="../css/login&join/join.css">
...
<div class="all-page">
	<div class="join-text"><div class="img"><img src="../images/index/join_logo.png" width="80" height="45" alt="웹툰리뷰"></div>회원가입</div>
			...
			<form>
				...
				<div class="content-box">
					...
					<select name="emailaddr-select" id="eamiladdr-select">
						...
						<option value="gmail.com" se>gmail.com</option>
