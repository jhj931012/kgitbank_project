...
<body>
	...
	<section>
		...
		<center>
			<div id="wrapper">
				<ul id="header_navi">
					<li><a class="title" href="#" onclick="openLayer('layerPop', 32, 33)"><img class="thumbnail" src="../images/tagPage/main/호랑이형님.jpg"><span>호랑이형님</span></a></li>
					<div id="layerPop">
						<img class="slide_img" src="../images/tagPage/main/호랑이형님_s.jpg">
						<%--<img
                     ...
                     src="../images/image1/image1_5.png">--%>
						...
						<div id="pop_menu">
							<ul class="pop_list">
								...
								<div style="display: inline-block; border-radius: 100%; font-size: 5px; height: 10px;"><button  onclick="closeLayer('layerPop')" class="close"><i class="fa-solid fa-x"></i></button></div>
							</ul>
						</div>
					</div>

					<li><a class="title" href="#" onclick="openLayer('layerPop2', 32, 33)"><img class="thumbnail"
							src="../images/tagPage/main/퀘스트지상주의.jpg"
						><span>퀘스트 지상주의</span></a></li>
					<div id="layerPop2">
						<img class="slide_img" src="../images/tagPage/main/퀘스트지상주의.jpg">
						<h1>퀘스트 지상주의</h1>
					...
					<li><a class="title" href="#" onclick="openLayer('layerPop3', 32, 33)"><img class="thumbnail"
							src="../images/tagPage/main/외모지상주의.jpg"
						><span>외모지상주의</span></a></li>
					<div id="layerPop3">
						<img class="slide_img" src="../images/tagPage/main/외모지상주의.jpg">
						<h1>외모지상주의</h1>
					...
					<li><a class="title" href="#" onclick="openLayer('layerPop4', 32, 33)"><img class="thumbnail"
							src="../images/tagPage/main/여신강림.jpg"
						><span>여신강림!</span></a></li>
					<div id="layerPop4">
						<img class="slide_img" src="../images/tagPage/main/여신강림.jpg">
						<h1>여신강림!</h1>
					...
					<li><a class="title" href="#" onclick="openLayer('layerPop5', 32, 33)"><img class="thumbnail"
							src="../images/tagPage/main/독립일기.jpg"
						><span>독립일기</span></a></li>
					<div id="layerPop5">
						<img class="slide_img" src="../images/tagPage/main/독립일기.jpg">
						<h1>독립일기</h1>
					...
					<li><a class="title" href="#" onclick="openLayer('layerPop6', 32, 33)"><img class="thumbnail"
							src="../images/tagPage/main/참교육.jpg"
						><span>참교육</span></a></li>
					<div id="layerPop6">
						<img class="slide_img" src="../images/tagPage/main/참교육.jpg">
						<h1>참교육</h1>
					...
					<li><a class="title" href="#" onclick="openLayer('layerPop7', 32, 33)"><img class="thumbnail"
							src="../images/tagPage/main/화산귀환.jpg"
						><span>화산귀환</span></a></li>
					<div id="layerPop7">
						<img class="slide_img" src="../images/tagPage/main/화산귀환.jpg">
						<h1>화산귀환</h1>
					...
					<li><a class="title" href="#" onclick="openLayer('layerPop8', 32, 33)"><img class="thumbnail"
							src="../images/tagPage/main/갓오하.jpg"
						><span>갓 오브 하이스쿨</span></a></li>
					<div id="layerPop8">
						<img class="slide_img" src="../images/tagPage/main/갓오하.jpg">
						<h1>갓 오브 하이스쿨</h1>
					...
					<li><a class="title" href="#" onclick="openLayer('layerPop9', 32, 33)"><img class="thumbnail"
							src="../images/tagPage/main/윈드브레이커.jpg"
						><span>윈드 브레이커</span></a></li>
					<div id="layerPop9">
						<img class="slide_img" src="../images/tagPage/main/윈드브레이커.jpg">
						<h1>윈드 브레이커</h1>
					...
					<li><a class="title" href="#" onclick="openLayer('layerPop10', 32, 33)"><img class="thumbnail"
							src="../images/tagPage/main/위닝샷.jpg" width="168px" height="224px"
						><span>위닝샷!</span></a></li>
					<div id="layerPop10">
						<img class="slide_img" src="../images/tagPage/main/위닝샷.jpg">
						<h1>위닝샷!</h1>
					...
					<li><a class="title" href="#" onclick="openLayer('layerPop11', 32, 33)"><img class="thumbnail"
							src="../images/tagPage/main/신의탑.jpg" width="168px" height="224px"
						><span>신의 탑</span></a></li>
					<div id="layerPop11">
						<img class="slide_img" src="../images/tagPage/main/신의탑.jpg">
						<h1>신의 탑</h1>
					...
					<li><a class="title" href="#" onclick="openLayer('layerPop12', 32, 33)"><img class="thumbnail"
							src="../images/tagPage/main/후궁스캔들.jpg" width="168px" height="224px"
						><span>후궁 스캔들</span></a></li>
					<div id="layerPop12">
						<img class="slide_img" src="../images/tagPage/main/후궁스캔들.jpg">
						<h1>후궁 스캔들</h1>
