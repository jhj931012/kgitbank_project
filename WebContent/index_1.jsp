...
<link rel="stylesheet" type="text/css"
	href="plugins/web-fonts-with-css/css/all.css" />
<script>
			...
			<div class="slider1">
				<div class="thumbnail-inner" style="text-align: center;">
					<div  style="text-align: center;">
						<a href="#"><img src="./images/index/header-Thumbnail/이름모름.jpg"></a>
					</div>
				</div>
				<div class="thumbnail-inner">
					<div  style="text-align: center;">
						<a href="#"><img src="./images/index/header-Thumbnail/신의탑.jpg"></a>
					</div>
				</div>
				<div class="thumbnail-inner">
					<div>
						<a href="#"><img src="./images/index/header-Thumbnail/main_image_01.jpg"></a>
					</div>
				</div>
				<div class="thumbnail-inner">
					<div>
						<a href="#"><img src="./images/index/header-Thumbnail/main_image_02.jpg"></a>
					</div>
				</div>
				<div class="thumbnail-inner">
					<div>
						<a href="#"><img src="./images/index/header-Thumbnail/main_image_03.jpg" ></a>
					</div>
				</div>
			</div>
		</div>
